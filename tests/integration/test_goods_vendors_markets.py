...
@pytest.mark.asyncio
class TestGoodsVendorsMarkets:
    # ── Goods ─────────────────────────────────────────────────────────────────────

    async def test_admin_can_create_good(self, client: AsyncClient, admin_token: str):
    ...
    async def test_viewer_cannot_create_good(
    ...
    async def test_list_goods_returns_all(self, client: AsyncClient, admin_token: str):
        await client.post(
            "/api/v1/goods",
    ...
    async def test_create_good_invalidates_cache(
        self, client: AsyncClient, admin_token: str, a_good: dict
    ):
    ...
    async def test_vendor_can_register_profile(
    ...
    async def test_viewer_cannot_register_vendor(
        self, client: AsyncClient, viewer_token: str
    ):
        resp = await client.post(
            "/api/v1/vendors",
    ...
    async def test_duplicate_vendor_profile_returns_400(
        self, client: AsyncClient, vendor_token: str
    ):
    ...
    async def test_admin_can_create_market(self, client: AsyncClient, admin_token: str):
        resp = await client.post(
            "/api/v1/markets",
    ...
    async def test_viewer_cannot_create_market(
        self, client: AsyncClient, viewer_token: str
    ):
        resp = await client.post(
            "/api/v1/markets",
